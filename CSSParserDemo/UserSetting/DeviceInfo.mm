...
static BOOL g_is812hScreen = NO;
static BOOL g_hasDetectIs812hScreen = NO;
...
+ (BOOL) is812hScreen
{
    if (g_hasDetectIs812hScreen == NO) {
        g_hasDetectIs812hScreen = YES;
        
        int height = QDScreenHeightOri(UIInterfaceOrientationPortrait);
        g_is812hScreen = (height == 812);
    }
    return g_is812hScreen;
}
